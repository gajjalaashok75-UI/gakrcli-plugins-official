---
name: session-report
description: Generate an explorable HTML report of GAKRCLI session usage (tokens, cache, subagents, skills, expensive prompts) from ~/.gakrcli/projects transcripts.
---

# Session Report

Produce a self-contained HTML report of GAKRCLI usage and save it to the current working directory.
