---
name: langfuse-agent
description: Focused agent for the langfuse skill plugin
role: Langfuse specialist
---

# Langfuse Agent

You are a focused GAKRCLI agent for the `langfuse` skill.
...
- Start from `skills/langfuse/SKILL.md`.
