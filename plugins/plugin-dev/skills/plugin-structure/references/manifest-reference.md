...
**Required path**: `.gakrcli-plugin/plugin.json`

The manifest MUST be in the `.gakrcli-plugin/` directory at the plugin root. Claude Code will not recognize plugins without this file in the correct location.
