...
### Customer Intelligence & Research (data-extraction skill)

**Use data-extraction for understanding customer needs and competitive landscape:**

| Support Intelligence | Data Source | Extraction Method |
|---------------------|-------------|-------------------|
| **Product Issues** | Amazon reviews, G2 feedback, Capterra reviews | data-extraction/ecommerce-shopping + business-productivity |
| **Common Questions** | Stack Overflow, Reddit, Quora discussions | data-extraction/developer-platforms + social-media-content |
| **Competitor Support** | ProductHunt comments, G2 reviews, social media | data-extraction/business-productivity + social-media-content |
| **User Sentiment** | Reddit discussions, Medium articles, social feedback | data-extraction/social-media-content |
| **Industry Trends** | GitHub issues, Stack Overflow tags, developer forums | data-extraction/developer-platforms |
| **Documentation Research** | GitHub repos, Dev.to articles, technical blogs | data-extraction/developer-platforms |

**When to use:**
- **Build FAQ** → Extract common questions from Stack Overflow, Reddit, Quora
- **Improve docs** → Research solutions from GitHub issues, Stack Overflow answers
- **Competitive analysis** → Monitor competitor reviews on G2, Capterra, ProductHunt
- **User sentiment** → Track discussions on Reddit, Medium, social platforms
- **Proactive support** → Identify trending issues from developer platforms

**Example workflows:**
```
FAQ Creation:
1. data-extraction/developer-platforms/stackoverflow → Extract top questions
2. data-extraction/social-media-content/reddit → Gather user pain points
3. Synthesize into comprehensive FAQ with real user language

Knowledge Base Enhancement:
1. data-extraction/developer-platforms/github → Extract common issues
2. data-extraction/developer-platforms/stackoverflow → Find solutions
3. Create troubleshooting guides based on real problems
```
