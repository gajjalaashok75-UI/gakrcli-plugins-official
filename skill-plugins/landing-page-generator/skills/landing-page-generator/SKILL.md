...
### Core Frontend Skills (frontend-atlas)

| Skill | Purpose | When to Use |
|-------|---------|-------------|
| **frontend-developer** | React 19+, Next.js 15+ implementation | Building the actual landing page components |
| **ui-ux-designer** | User experience design, interface patterns | Designing user flows, wireframes before generation |
| **tailwind-design-system** | Tailwind-based design systems, tokens | Creating consistent design tokens and component libraries |
| **magic-animator** | Animation patterns, transitions, micro-interactions | Adding smooth animations to landing page sections |
| **scroll-experience** | Scroll-based animations, parallax effects | Creating scroll-driven experiences for storytelling |
| **frontend-security-coder** | Frontend security patterns, XSS prevention | Ensuring secure form handling and data validation |

**When to use:** Invoke frontend-atlas skills for implementation details, animations, and advanced interactions.

### Visual Content Generation

| Content Type | Use Skill | When to Use |
|--------------|-----------|-------------|
| **Hero backgrounds** | image-generation | Generate custom hero section backgrounds, product visuals |
| **Hero videos** | video-generation | Create animated backgrounds for immersive hero sections |
| **Product images** | image-generation | Generate product mockups, feature illustrations |
| **Icons & illustrations** | image-generation | Custom icons, decorative graphics, section dividers |

**Workflow for visual content:**
1. Design landing page layout (this skill)
2. Generate visual assets (image-generation or video-generation)
3. Optimize for web performance (frontend-developer)
4. Integrate into components (frontend-developer)
5. Add scroll animations (scroll-experience)

### Marketing & Content

| Skill | Purpose | When to Use |
|-------|---------|-------------|
| **Brand Voice Analyzer** | Analyze brand voice from existing content | Run before generation to establish voice profile |
| **content-production** | Marketing copy, blog posts, case studies | Generate supporting content for landing page |
| **seo-optimizer** | SEO optimization, keyword research | Optimize meta tags, headings, and content for search |

### Design & Styling

| Skill | Purpose | When to Use |
|-------|---------|-------------|
| **tailwind-patterns** | Tailwind CSS v4 patterns and utilities | Advanced Tailwind techniques and custom utilities |
| **web-design-guidelines** | Web interface guidelines compliance | Ensure accessibility and design standards |
| **liquid-glass-design** | Glassmorphism, modern UI aesthetics | Creating premium, modern UI designs |

### Testing & Optimization

| Skill | Purpose | When to Use |
|-------|---------|-------------|
| **e2e-testing** | End-to-end testing strategies | Test landing page flows, forms, CTAs |
| **frontend-patterns** | Performance optimization patterns | Optimize Core Web Vitals and load times |
| **code-reviewer** | Code review and quality checks | Review generated code for best practices |

### Deployment & Analytics

| Skill | Purpose | When to Use |
|-------|---------|-------------|
| **vercel-deployment** | Vercel deployment workflows | Deploy landing pages to Vercel |
| **vercel-ai-sdk-expert** | Vercel AI SDK integration | Add AI-powered features (chatbots, personalization) |
| **nextjs-turbopack** | Next.js 16+ and Turbopack optimization | Optimize build and development performance |

### Data & Research

| Skill | Purpose | When to Use |
|-------|---------|-------------|
| **data-extraction** | Extract data from 47+ platforms | Research competitor landing pages, user feedback |
| **data-extraction/developer-platforms** | GitHub, Stack Overflow, Hacker News | Research popular landing page patterns and libraries |
| **data-extraction/social-media-content** | Reddit, Medium discussions | Understand user pain points and messaging |

**Common workflows:**
- Research landing page patterns → data-extraction/developer-platforms/github
- Analyze competitor messaging → data-extraction/social-media-content/reddit
- Find conversion optimization tips → data-extraction/developer-platforms/stackoverflow
...
1. **landing-page-generator** (this skill) — Generate initial components
2. **frontend-developer** — Implement and customize components
3. **seo-optimizer** — Optimize for search engines
4. **e2e-testing** — Test conversion flows

### Premium Landing Page with Visuals
1. **ui-ux-designer** — Design layout and user flow
2. **image-generation** — Generate hero background and product images
3. **video-generation** — Create hero video background (optional)
4. **landing-page-generator** (this skill) — Generate components with copy
5. **frontend-developer** — Integrate visual assets
6. **scroll-experience** — Add scroll-triggered animations
7. **magic-animator** — Add micro-interactions and transitions
8. **frontend-patterns** — Optimize performance
9. **vercel-deployment** — Deploy to production

### Data-Driven Landing Page
1. **data-extraction** — Research competitor landing pages and user feedback
2. **Brand Voice Analyzer** — Analyze brand voice from existing content
3. **landing-page-generator** (this skill) — Generate components with optimized copy
4. **seo-optimizer** — Keyword research and optimization
5. **frontend-developer** — Implement with analytics tracking
6. **e2e-testing** — A/B test different variants

### Enterprise Landing Page
1. **ui-ux-designer** — Design enterprise-grade layout
2. **tailwind-design-system** — Create design system tokens
3. **landing-page-generator** (this skill) — Generate enterprise-style components
4. **frontend-security-coder** — Implement secure forms and data handling
5. **frontend-patterns** — Ensure accessibility and performance
6. **code-reviewer** — Review for enterprise standards
7. **vercel-deployment** — Deploy with custom domain
...
- Visual content → image-generation, video-generation
- Animations → magic-animator, scroll-experience
- Performance → frontend-patterns, nextjs-turbopack
- Testing → e2e-testing, code-reviewer
- Deployment → vercel-deployment

**Remember:** This skill generates the structure and copy. Use frontend-atlas skills for advanced implementation, animations, and interactions.
