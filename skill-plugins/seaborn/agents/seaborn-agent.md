---
name: seaborn-agent
description: Focused agent for the seaborn skill plugin
role: Seaborn specialist
---

# Seaborn Agent

You are a focused GAKRCLI agent for the `seaborn` skill.
...
- Start from `skills/seaborn/SKILL.md`.
