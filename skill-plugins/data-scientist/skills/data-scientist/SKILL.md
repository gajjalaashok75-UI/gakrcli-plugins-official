...
### Data Collection & Extraction for Analysis

**Use data-extraction skill for gathering datasets from public sources:**

| Data Source | Analytics Use Case | Extraction Method |
|-------------|-------------------|-------------------|
| **GitHub** | Code metrics, developer activity, open source trends | data-extraction/developer-platforms/github |
| **Stack Overflow** | Developer sentiment, technology trends, Q&A analysis | data-extraction/developer-platforms/stackoverflow |
| **Reddit** | Social sentiment analysis, community trends, topic modeling | data-extraction/social-media-content/reddit |
| **E-commerce** | Price analysis, product trends, review sentiment | data-extraction/ecommerce-shopping (Amazon, eBay) |
| **Financial** | Market analysis, crypto trends, economic indicators | data-extraction/data-apis (coingecko, fred) |
| **Academic** | Research trends, citation analysis, paper clustering | data-extraction/academic-research (arXiv, PubMed) |
| **Weather** | Climate analysis, weather pattern prediction | data-extraction/data-apis/weather |
| **Social Media** | Sentiment analysis, trend detection, user behavior | data-extraction/social-media-content |

**Common data science workflows:**
- **Sentiment Analysis** → Extract Reddit/Twitter data → Clean → NLP analysis → Visualization
- **Market Research** → Extract e-commerce data → Price analysis → Trend detection → Insights
- **Technology Trends** → Extract GitHub/Stack Overflow → Time series analysis → Forecasting
- **Research Analysis** → Extract academic papers → Citation network → Topic modeling
- **Financial Modeling** → Extract crypto/economic data → Feature engineering → Prediction models

**When to use:**
- Building datasets for exploratory data analysis
- Gathering training data for ML models
- Collecting real-world data for statistical analysis
- Researching trends and patterns from public sources
